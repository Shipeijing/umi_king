    ...
    <div className={styles.content}>
      ...
      <div className={styles.index}>
        ...
        <div className={styles.navBut}>
          <Button type="primary" shape="round" icon={<GlobalOutlined />}>
            世界
          </Button>
          <Button type="" shape="round" icon={<TeamOutlined />}>
            关注
          </Button>
          <Button type="" shape="round" icon={<WomanOutlined />}>
            男性
          </Button>
          <Button type="" shape="round" icon={<ManOutlined />}>
            女性
          </Button>
        </div>
